##result of MPNN
##test hydrogen atom energy and error of potential(table1)
...
# potential.load_state_dict(torch.load('ones_Potential_128_chu0.01_lam1e-7.pkl'))

# potential.load_state_dict(torch.load('ones_Potential_chu0.01_lam0.001.pkl'))#Call learning results
potential.load_state_dict(torch.load('ones_32Potential_chu0.01_lam0.001.pkl'))#Call learning results
...
print('EM',Energyt) #result of energy
